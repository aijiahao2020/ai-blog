...
MySQL - 8.0.27 : Database - aiblog_admin
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`aiblog_admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `schedule_job`(`job_id`,`bean_name`,`params`,`cron_expression`,`status`,`remark`,`create_time`) values (1,'testTask','renren','0 0/30 * * * ?',0,'参数测试','2023-09-10 04:07:40');
...
insert  into `sys_captcha`(`uuid`,`code`,`expire_time`) values ('0bd4225f-7e0b-4717-8cdb-cd5e2df38520','e4b2w','2023-09-10 15:48:44'),('47531fec-dfc9-4ab5-8149-367057003b62','dec63','2023-09-10 16:22:00'),('49dd0868-c370-4723-8cc5-7c2cc22ec535','xn7n5','2023-09-10 16:01:08'),('d9d1f39b-765b-4d93-8569-1a8cc398659c','6nnyc','2023-09-10 16:11:56'),('dfbed3d4-af3d-44e6-8093-42a4a91dab13','3y24w','2023-09-10 16:03:08');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统配置信息表';
...
insert  into `sys_user`(`user_id`,`username`,`password`,`salt`,`email`,`mobile`,`status`,`create_user_id`,`create_time`) values (1,'admin','9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d','YzcmCZNvbXocrsz9dm8e','aijiahao2020@outlook.com','13612345678',1,1,'2016-11-11 11:11:11');
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户与角色对应关系';
...
insert  into `sys_user_token`(`user_id`,`token`,`expire_time`,`update_time`) values (1,'13e3af82e84331f23abf6f3a573efd3b','2023-09-11 04:29:45','2023-09-10 16:29:45');
